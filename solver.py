    ...
    def create_labels(self, c_org, c_dim=5, dataset='CelebA', selected_attrs=None):
        ...
        if dataset == 'CelebA':
            ...
            for i, attr_name in enumerate(selected_attrs):
                if attr_name in ['hoodie', 'long_sleeve', 't-shirt', 'sleeveless', 'crop_top']:
                    hair_color_indices.append(i)

        c_trg_list = []
        # for i in range(c_dim):                                                    ######### 바꾸기 전 코드
        for i in range(c_dim):                                                          ######### 바꾼 코드
            print(i)
            if dataset == 'CelebA':
                c_trg = c_org.clone()
                print(c_trg)
...
#         plt.imshow(np.transpose(npimg, (1, 2, 0)))
    ...
    def train(self):
        ...
        for i in range(start_iters, self.num_iters):
            ...
            # print(f'c_trg : {c_trg}')
            # print(self.model(x_real, c_trg, None))
